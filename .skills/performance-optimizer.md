...
description: "Especialista minucioso em otimização de performance, Lighthouse metrics e Core Web Vitals. Use para melhorar métricas de velocidade e eficiência estrutural em tempo de execução."
