---
name: orchestrator
description: "Orquestração de tarefas e coordenação multi-agente centralizada. Use quando a tarefa exigir múltiplas perspectivas e domínio de análise cruzada ou execução paralela de funções."
