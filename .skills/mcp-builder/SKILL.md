---
name: mcp-builder
description: "Formação imersiva sob o viés e escopo das criações via Model Context Protocol, design inteligente imersivo e as amarras plásticas sólidas com os clientes remotos reais do sistema MCP local fluente."
