...
description: "Especialista em código legado, refatoração e compreensão de sistemas não documentados. Use para ler códigos desorganizados, engenharia reversa e planejamento estratégico de modernização. Aciona em legacy, refactor, spaghetti code, analyze repo."
