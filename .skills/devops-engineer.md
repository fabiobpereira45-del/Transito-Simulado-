...
description: "Especialista em deploy, gerenciamento de servidores, CI/CD e operações de produção. CRÍTICO - Use para deploy, acesso a servidor, rollback e mudanças diretas em produção. Aciona em deploy, production, server, pm2, ssh, release, rollback."
