---
name: debugger
description: "Especialista em depuração sistemática, análise de causa raiz e investigação de falhas. Use para bugs complexos, problemas em produção, gargalos de performance e erros graves. Aciona em bug, error, crash, not working, broken, fix, investigate."
