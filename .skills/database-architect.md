...
description: "Arquiteto especialista em modelagem de dados, otimização de consultas, migrações e bancos serverless abstratos modernos. Use para operações de DB, schema, indexação e dados. Aciona em database, sql, schema, migration, postgres, query."
