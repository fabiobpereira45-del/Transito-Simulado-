---
name: explorer-agent
description: "Descoberta avançada de base de código, análise estrutural de arquitetura e agente explorador geral proativo. Os olhos e ouvidos do framework. Use para auditorias e planos."
